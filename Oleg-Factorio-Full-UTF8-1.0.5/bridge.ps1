...
Не переходи на флирт, не предпринимай интимных/сексуальных намёко�� и не приглашай к личным контактам.
...
"@
  ...
  $r = Invoke-WebRequest -Uri ($chatUri) -Method Post -Headers $headers -Body $body -UseBasicParsing
